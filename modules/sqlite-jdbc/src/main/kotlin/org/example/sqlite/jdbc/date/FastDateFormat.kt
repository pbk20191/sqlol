 ...
 * 
 * 
 * To obtain an instance of FastDateFormat, use one of the static factory methods: [ ][.getInstance], [.getDateInstance], [ ][.getTimeInstance], or [.getDateTimeInstance]
 * 
 * 
 ...
 * `SimpleDateFormat` is not thread-safe in any JDK version, nor will it be as Sun have closed
 * the bug/RFE.
 * 
 * 
 * All patterns are compatible with SimpleDateFormat (except time zones and some year patterns -
 * see below).
 * 
 * 
 ...
 * @version $Id$
 */
class FastDateFormat protected constructor(
    pattern: String,
    timeZone: TimeZone,
    locale: Locale,
     ...
     * 
     * @param pattern [SimpleDateFormat] compatible pattern
     ...
     */
    init {
        printer = FastDatePrinter(pattern, timeZone, locale)
     ...
     * 
     * @return the pattern, [SimpleDateFormat] compatible
     */
    ...
    override fun equals(obj: Any?): Boolean {
        if (obj is FastDateFormat == false) {
            return false
        }
        val other = obj
    ...
    companion object {
         ...
         */
        fun getDateInstance(
            style: Int, timeZone: TimeZone?, locale: Locale?
        ): FastDateFormat {
        ...
        fun getDateTimeInstance(
            dateStyle: Int, timeStyle: Int, locale: Locale?
        ): FastDateFormat {
         ...
         */
        fun getDateTimeInstance(
            dateStyle: Int, timeStyle: Int, timeZone: TimeZone?
        ): FastDateFormat {
