...
object LoggerFactory {
     ...
     */
    @JvmStatic
    fun getLogger(hostClass: Class<*>): org.example.sqlite.jdbc.util.Logger {
        if (USE_SLF4J) {
    ...
    private class JDKLogger(hostClass: Class<*>) : org.example.sqlite.jdbc.util.Logger {
        val logger: Logger
    ...
    private class SLF4JLogger(hostClass: Class<*>) : org.example.sqlite.jdbc.util.Logger {
