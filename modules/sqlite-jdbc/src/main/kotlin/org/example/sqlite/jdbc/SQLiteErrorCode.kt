 ...
 * 
 * @author leo
 * @see [https://www.sqlite.org/c3ref/c_abort.html](https://www.sqlite.org/c3ref/c_abort.html)
 */
 ...
 */(@JvmField val code: Int, val message: String) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun getErrorCode(errorCode: Int): SQLiteErrorCode {
            for (each in entries) {
