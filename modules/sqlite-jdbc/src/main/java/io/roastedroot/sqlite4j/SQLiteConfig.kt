...
import io.roastedroot.sqlite4j.JDBC.Companion.createConnection
import io.roastedroot.sqlite4j.SQLiteConnectionConfig.Companion.fromPragmaTable
...
class SQLiteConfig @JvmOverloads constructor(private val pragmaTable: Properties = Properties()) {
    ...
    fun createConnection(url: String): Connection? {
        return createConnection(url, toProperties())
    }
    ...
    init {
        ...
        this.defaultConnectionConfig = fromPragmaTable(pragmaTable)
