...
public abstract class JDBC3Statement extends CoreStatement {
    ...
    protected JDBC3Statement(@NonNull SQLiteConnection conn) {
        super(conn);
        this.queryTimeout = 0;
    }
     ...
     */
    public ResultSet executeQuery(@NonNull String sql, boolean closeStmt) throws SQLException {
     ...
     */
    public void setCursorName(@NonNull String name) {}
    ...
    protected <T> T withConnectionTimeout(@NonNull SQLCallable<T> callable) throws SQLException {
