...
import io.roastedroot.sqlite4j.jdbc4.JDBC4Connection
import io.roastedroot.sqlite4j.util.LoggerFactory.getLogger
import java.sql.*
import java.util.*
...
class JDBC : Driver {
    ...
    companion object {
        private val logger = getLogger(JDBC::class.java)
        ...
        fun createConnection(
            ...
            url = url.trim { it <= ' ' }
            return JDBC4Connection(url, extractAddress(url), prop ?: Properties())
        }
    }
}
