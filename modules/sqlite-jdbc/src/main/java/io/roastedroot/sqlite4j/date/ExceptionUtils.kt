...
object ExceptionUtils {
     ...
     * 
     * 
     * The use of this technique may be controversial, but exceedingly useful to library
     * developers. `
     ...
     * 
     * 
     * This is an alternative to the more conservative approach of wrapping the checked exception
     ...
     * @throws throwable
     */
    fun <R> rethrow(throwable: Throwable): R {
        // All Kotlin exceptions are unchecked, so simply throw the given throwable as-is.
        throw throwable
    }
}
